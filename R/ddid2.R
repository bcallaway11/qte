# =============================================================================
# Title: Distributional DiD with two periods (ddid2)
# Description: Implements the Callaway-Li-Oka (2018) quantile treatment effect
#   estimator using two periods of panel data. The key identification assumption
#   is distributional parallel trends combined with a dependence restriction.
