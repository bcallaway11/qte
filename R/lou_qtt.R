# =============================================================================
# Title: Lagged Outcome Unconfoundedness QTT (lou_qtt)
...
#'   unconfoundedness. Called internally by \code{\link{lou_qtt}} via
#'   \code{ptetools::pte()}.
#'
...
#'
#' @export
lou_qtt <- function(yname, gname, tname, idname = NULL, data,
                    xformula          = ~1,
